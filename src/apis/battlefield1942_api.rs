...
/// struct for typed errors of method [`bf1942_servers_bf1942_servers_get`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum Bf1942ServersBf1942ServersGetError {
    Status404(),
    Status422(models::HttpValidationError),
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`bf1942_statusarray_bf1942_statusarray_get`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum Bf1942StatusarrayBf1942StatusarrayGetError {
    Status404(),
    Status422(models::HttpValidationError),
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`bf1942status_bf1942_status_get`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum Bf1942statusBf1942StatusGetError {
    Status404(),
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`logged_server_data_bf1942_serverarray_get`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum LoggedServerDataBf1942ServerarrayGetError {
    Status422(models::HttpValidationError),
    UnknownValue(serde_json::Value),
}


pub async fn bf1942_servers_bf1942_servers_get(configuration: &configuration::Configuration, name: &str, r#type: Option<models::LegacyBfQueryType>) -> Result<models::OlderTitleSearch, Error<Bf1942ServersBf1942ServersGetError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_name = name;
    let p_type = r#type;

    let uri_str = format!("{}/bf1942/servers/", configuration.base_path);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<Bf1942ServersBf1942ServersGetError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}

pub async fn bf1942_statusarray_bf1942_statusarray_get(configuration: &configuration::Configuration, days: Option<i32>) -> Result<models::StatusArray, Error<Bf1942StatusarrayBf1942StatusarrayGetError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_days = days;

    let uri_str = format!("{}/bf1942/statusarray/", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<Bf1942StatusarrayBf1942StatusarrayGetError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}

pub async fn bf1942status_bf1942_status_get(configuration: &configuration::Configuration, ) -> Result<models::OlderGameStatus, Error<Bf1942statusBf1942StatusGetError>> {

    let uri_str = format!("{}/bf1942/status/", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<Bf1942statusBf1942StatusGetError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}

pub async fn logged_server_data_bf1942_serverarray_get(configuration: &configuration::Configuration, name: &str, r#type: Option<models::LegacyBfQueryType>, days: Option<i32>) -> Result<serde_json::Value, Error<LoggedServerDataBf1942ServerarrayGetError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_name = name;
    let p_type = r#type;
    let p_days = days;

    let uri_str = format!("{}/bf1942/serverarray/", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<LoggedServerDataBf1942ServerarrayGetError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
