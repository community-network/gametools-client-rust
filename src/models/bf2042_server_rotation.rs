...
pub struct Bf2042ServerRotation {
    #[serde(rename = "location")]
    pub location: String,
    #[serde(rename = "preRoundSize")]
    pub pre_round_size: String,
    #[serde(rename = "rounds")]
    pub rounds: i32,
    ...
    pub warm_up_size: i32,
    #[serde(rename = "mutators")]
    pub mutators: Vec<models::Bf2042Mutators>,
    #[serde(rename = "allowedSpectators")]
    pub allowed_spectators: i32,
    #[serde(rename = "image")]
    pub image: String,
}

impl Bf2042ServerRotation {
    pub fn new(location: String, pre_round_size: String, rounds: i32, game_size: i32, mapname: String, mode: String, warm_up_size: i32, mutators: Vec<models::Bf2042Mutators>, allowed_spectators: i32, image: String) -> Bf2042ServerRotation {
        Bf2042ServerRotation {
            location,
            pre_round_size,
            rounds,
            game_size,
