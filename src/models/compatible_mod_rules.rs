...
pub struct CompatibleModRules {
    #[serde(rename = "rules")]
    pub rules: std::path::PathBuf,
    #[serde(rename = "rulesVersion")]
    pub rules_version: i32,
    #[serde(rename = "blueprintRulesVersion")]
    pub blueprint_rules_version: i32,
}

impl CompatibleModRules {
    pub fn new(rules: std::path::PathBuf, rules_version: i32, blueprint_rules_version: i32) -> CompatibleModRules {
        CompatibleModRules {
            rules,
            rules_version,
