...
pub struct MenuItem {
    ...
    pub secondary: Box<models::InnerMenuEntry>,
    #[serde(rename = "main")]
    pub main: Box<models::Subentry>,
    #[serde(rename = "mixes")]
    pub mixes: Vec<models::SubMenuItem>,
}

impl MenuItem {
    pub fn new(secondary: models::InnerMenuEntry, main: models::Subentry, mixes: Vec<models::SubMenuItem>) -> MenuItem {
        MenuItem {
