...
pub struct TranslationMetadata {
    ...
    #[serde(rename = "localizedTextDesc", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub localized_text_desc: Option<Option<String>>,
}

impl TranslationMetadata {
    pub fn new(kind: String, translation_id: String, localized_text: String) -> TranslationMetadata {
        TranslationMetadata {
            kind,
            translation_id,
            localized_text,
            localized_text_desc: None,
        }
    }
}
