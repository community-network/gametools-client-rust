...
pub struct BfhDetailedServerInfo {
    #[serde(rename = "region")]
    pub region: String,
    ...
    pub players: Vec<models::Bf4PlayerList>,
    #[serde(rename = "noBotsPlayerAmount")]
    pub no_bots_player_amount: i32,
    #[serde(rename = "teams")]
    pub teams: Vec<models::Bf4Team>,
}

impl BfhDetailedServerInfo {
    pub fn new(region: String, current_map: String, current_map_image: String, description: String, player_amount: i32, prefix: String, smallmode: String, max_player_amount: i32, in_queue: i32, server_link: String, mode: String, settings: models::Bf3ServerSettings, rotation: Vec<models::ServerRotation>, players: Vec<models::Bf4PlayerList>, no_bots_player_amount: i32, teams: Vec<models::Bf4Team>) -> BfhDetailedServerInfo {
