...
pub struct OriginalModRules {
    #[serde(rename = "compatibleRules")]
    pub compatible_rules: Vec<models::CompatibleModRules>,
    #[serde(rename = "incompatibleRules")]
    pub incompatible_rules: Vec<models::InCompatibleModRules>,
}

impl OriginalModRules {
    pub fn new(compatible_rules: Vec<models::CompatibleModRules>, incompatible_rules: Vec<models::InCompatibleModRules>) -> OriginalModRules {
        OriginalModRules {
            compatible_rules,
            incompatible_rules,
        }
