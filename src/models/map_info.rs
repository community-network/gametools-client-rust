...
pub struct MapInfo {
    ...
    pub mutators: Vec<models::Mutator>,
    #[serde(rename = "location")]
    pub location: String,
    #[serde(rename = "preRoundSize")]
    pub pre_round_size: i32,
...
impl MapInfo {
    pub fn new(mapname: String, image: String, mode: String, game_size: i32, rounds: i32, mutators: Vec<models::Mutator>, location: String, pre_round_size: i32, warm_up_size: i32, allowed_spectators: i32) -> MapInfo {
        MapInfo {
            mapname,
            image,
            mode,
