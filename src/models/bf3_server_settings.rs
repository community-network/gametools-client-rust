...
pub struct Bf3ServerSettings {
    #[serde(rename = "All")]
    pub all: std::collections::HashMap<String, i32>,
}

impl Bf3ServerSettings {
    pub fn new(all: std::collections::HashMap<String, i32>) -> Bf3ServerSettings {
        Bf3ServerSettings {
            all,
        }
    }
