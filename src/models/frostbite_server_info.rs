...
pub struct FrostbiteServerInfo {
    #[serde(rename = "name")]
    pub name: String,
...
impl FrostbiteServerInfo {
    pub fn new(name: String, description: String, level: String, mode: String, region: String, country: String, maps: Vec<String>, owner: String, settings: Vec<String>, servertype: String) -> FrostbiteServerInfo {
        FrostbiteServerInfo {
            name,
            description,
            level,
