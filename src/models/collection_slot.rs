...
pub struct CollectionSlot {
    ...
    pub mix_id: String,
    #[serde(rename = "meta")]
    pub meta: Box<models::MutatorCategory>,
    #[serde(rename = "matchmakingCommand")]
    pub matchmaking_command: Box<models::MatchmakingCommand>,
}

impl CollectionSlot {
    pub fn new(slot_id: String, mix_id: String, meta: models::MutatorCategory, matchmaking_command: models::MatchmakingCommand) -> CollectionSlot {
        CollectionSlot {
            slot_id,
            mix_id,
            meta: Box::new(meta),
            matchmaking_command: Box::new(matchmaking_command),
        }
    }
}
