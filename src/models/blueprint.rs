...
pub struct Blueprint {
    ...
    #[serde(rename = "name")]
    pub name: String,
    #[serde(rename = "availableGameData")]
    pub available_game_data: Box<models::AvailableGameData>,
    #[serde(rename = "metadata")]
    pub metadata: Box<models::Metadata>,
    #[serde(rename = "playgroundConstraints")]
    pub playground_constraints: Box<models::PlaygroundConstraints>,
    #[serde(rename = "availableTags")]
    pub available_tags: Box<models::AvailableTag>,
}

impl Blueprint {
    pub fn new(blueprint_type: String, name: String, available_game_data: models::AvailableGameData, metadata: models::Metadata, playground_constraints: models::PlaygroundConstraints, available_tags: models::AvailableTag) -> Blueprint {
        Blueprint {
            blueprint_type,
            name,
            available_game_data: Box::new(available_game_data),
            metadata: Box::new(metadata),
            playground_constraints: Box::new(playground_constraints),
            available_tags: Box::new(available_tags),
        }
    }
}
