...
pub struct BfvServerPlayers {
    #[serde(rename = "serverinfo")]
    pub serverinfo: Box<models::ServerInfo>,
    #[serde(rename = "teams")]
    pub teams: Vec<models::BfvServerTeam>,
    #[serde(rename = "que")]
...
impl BfvServerPlayers {
    pub fn new(serverinfo: models::ServerInfo, teams: Vec<models::BfvServerTeam>, que: Vec<models::FrostbiteServerPlayer>, loading: Vec<models::FrostbiteServerPlayer>, update_timestamp: i32) -> BfvServerPlayers {
        BfvServerPlayers {
