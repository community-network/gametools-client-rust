...
pub struct Bf1SeederServerPlayers {
    #[serde(rename = "gameId")]
    pub game_id: String,
    #[serde(rename = "serverinfo")]
    pub serverinfo: Box<models::FrostbiteServerInfo>,
    #[serde(rename = "teams")]
...
impl Bf1SeederServerPlayers {
    pub fn new(game_id: String, serverinfo: models::FrostbiteServerInfo, teams: Vec<models::FrostbiteServerTeam>, time_stamp: String) -> Bf1SeederServerPlayers {
