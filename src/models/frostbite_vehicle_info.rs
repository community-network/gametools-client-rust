...
pub struct FrostbiteVehicleInfo {
...
impl FrostbiteVehicleInfo {
    pub fn new(vehicle_name: String, r#type: String, image: String, kills: i32, kills_per_minute: i32, destroyed: i32, time_in: i32) -> FrostbiteVehicleInfo {
