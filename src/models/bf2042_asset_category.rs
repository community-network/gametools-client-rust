...
pub struct Bf2042AssetCategory {
    #[serde(rename = "childrenTags")]
    pub children_tags: Box<models::Bf2042ChildrenTags>,
    #[serde(rename = "meta")]
    pub meta: i32,
...
impl Bf2042AssetCategory {
    pub fn new(children_tags: models::Bf2042ChildrenTags, meta: i32, asset_id: String) -> Bf2042AssetCategory {
        Bf2042AssetCategory {
            children_tags: Box::new(children_tags),
            meta,
            asset_id,
        }
    }
