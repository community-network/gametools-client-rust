...
pub enum ExpandedStatusArrayType {
...
impl std::fmt::Display for ExpandedStatusArrayType {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        match self {
            Self::Amounts => write!(f, "amounts"),
            Self::Maps => write!(f, "maps"),
            Self::Modes => write!(f, "modes"),
            Self::Settings => write!(f, "settings"),
            Self::OwnerPlatform => write!(f, "ownerPlatform"),
        }
    }
}

impl Default for ExpandedStatusArrayType {
    fn default() -> ExpandedStatusArrayType {
        Self::Amounts
    }
}
