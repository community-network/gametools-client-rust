...
impl BfhClassInfo {
    pub fn new(class_name: String, image: String, alt_image: String, score: i32, service_star_amount: i32, service_star_progress: String, service_star_progress_amount: i32) -> BfhClassInfo {
        BfhClassInfo {
            class_name,
            image,
            alt_image,
