...
pub struct PlayerSession {
    ...
    #[serde(rename = "stats")]
    pub stats: Box<models::SessionStats>,
}

impl PlayerSession {
    pub fn new(player_id: i32, server_id: String, server_name: String, time_stamp: String, stats: models::SessionStats) -> PlayerSession {
        PlayerSession {
            player_id,
            server_id,
            server_name,
