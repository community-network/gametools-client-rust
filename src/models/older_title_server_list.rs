...
pub struct OlderTitleServerList {
    #[serde(rename = "prefix")]
    pub prefix: String,
    #[serde(rename = "mode")]
    pub mode: String,
...
impl OlderTitleServerList {
    pub fn new(prefix: String, mode: String, small_mode: String, player_amount: i32, max_players: i32, map: String, map_image: String, ip: String, port: String, server_link: String) -> OlderTitleServerList {
        OlderTitleServerList {
            prefix,
            mode,
            small_mode,
            player_amount,
