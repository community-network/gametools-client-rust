...
pub struct ManagerServerInfo {
    ...
    pub rotation: Vec<models::ManagerServerRotation>,
...
impl ManagerServerInfo {
    pub fn new(prefix: String, in_que: i32, server_info: String, player_amount: i32, max_player_amount: i32, url: String, map: String, smallmode: String, mode: String, rotation: Vec<models::ManagerServerRotation>, rotation_id: i32, created_date: i32, expiration_date: i32) -> ManagerServerInfo {
        ManagerServerInfo {
            prefix,
            in_que,
            server_info,
