...
pub struct BfvMultipleWeaponInfo {
    ...
    pub score_per_minute: String,
    #[serde(rename = "headshots")]
    pub headshots: String,
}

impl BfvMultipleWeaponInfo {
    pub fn new(weapon_name: String, id: String, kills: i32, accuracy: String, kills_per_minute: i32, hit_v_kills: i32, shots_hit: i32, shots_fired: i32, time_equipped: i32, r#type: String, image: String, score: String, score_per_minute: String, headshots: String) -> BfvMultipleWeaponInfo {
