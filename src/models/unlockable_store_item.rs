...
pub struct UnlockableStoreItem {
    #[serde(rename = "title")]
    pub title: String,
    #[serde(rename = "details")]
    pub details: Box<models::UnlockableDetails>,
    #[serde(rename = "unlocked")]
    pub unlocked: bool,
}

impl UnlockableStoreItem {
    pub fn new(title: String, details: models::UnlockableDetails, unlocked: bool) -> UnlockableStoreItem {
        UnlockableStoreItem {
            title,
