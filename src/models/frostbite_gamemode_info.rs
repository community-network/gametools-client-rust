...
pub struct FrostbiteGamemodeInfo {
    #[serde(rename = "wins")]
    pub wins: i32,
    #[serde(rename = "losses")]
    pub losses: i32,
...
impl FrostbiteGamemodeInfo {
    pub fn new(wins: i32, losses: i32, win_percent: String) -> FrostbiteGamemodeInfo {
        FrostbiteGamemodeInfo {
            wins,
            losses,
            win_percent,
        }
