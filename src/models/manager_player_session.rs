...
pub struct ManagerPlayerSession {
    #[serde(rename = "data")]
    pub data: Vec<models::PlayerSession>,
}

impl ManagerPlayerSession {
    pub fn new(data: Vec<models::PlayerSession>) -> ManagerPlayerSession {
