...
pub enum FrostbiteRegionsWithMultiple {
    #[serde(rename = "all")]
    All,
    #[serde(rename = "eu")]
    Eu,
...
impl std::fmt::Display for FrostbiteRegionsWithMultiple {
...
impl Default for FrostbiteRegionsWithMultiple {
    fn default() -> FrostbiteRegionsWithMultiple {
        Self::All
    }
}
