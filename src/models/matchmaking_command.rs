...
pub struct MatchmakingCommand {
    #[serde(rename = "scenarioName")]
    pub scenario_name: String,
    #[serde(rename = "attributes")]
    pub attributes: Vec<String>,
    #[serde(rename = "mode")]
    pub mode: Vec<models::CommandAttr>,
}

impl MatchmakingCommand {
    pub fn new(scenario_name: String, attributes: Vec<String>, mode: Vec<models::CommandAttr>) -> MatchmakingCommand {
        MatchmakingCommand {
            scenario_name,
            attributes,
            mode,
