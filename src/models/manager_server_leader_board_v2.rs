...
pub struct ManagerServerLeaderBoardV2 {
    #[serde(rename = "data")]
    pub data: Vec<models::ManagerPlayerLeaderBoardV2>,
}

impl ManagerServerLeaderBoardV2 {
    pub fn new(data: Vec<models::ManagerPlayerLeaderBoardV2>) -> ManagerServerLeaderBoardV2 {
