...
pub struct BattlelogVehicleStats {
    ...
    pub vehicles: Vec<models::BattlelogVehicleInfo>,
}

impl BattlelogVehicleStats {
    pub fn new(id: i32, vehicles: Vec<models::BattlelogVehicleInfo>) -> BattlelogVehicleStats {
