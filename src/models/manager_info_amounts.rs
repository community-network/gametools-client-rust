...
pub struct ManagerInfoAmounts {
    #[serde(rename = "communities")]
    pub communities: i32,
    #[serde(rename = "servers")]
    pub servers: i32,
    #[serde(rename = "perWeek")]
    pub per_week: Box<models::ManagerInfoPerWeek>,
}

impl ManagerInfoAmounts {
    pub fn new(communities: i32, servers: i32, per_week: models::ManagerInfoPerWeek) -> ManagerInfoAmounts {
        ManagerInfoAmounts {
            communities,
            servers,
