...
pub struct SparseIntMutator {
    #[serde(rename = "defaultValue")]
    pub default_value: i32,
    #[serde(rename = "size")]
    pub size: i32,
    #[serde(rename = "sparseValues")]
    pub sparse_values: Vec<models::SparseIntEntity>,
}

impl SparseIntMutator {
    pub fn new(default_value: i32, size: i32, sparse_values: Vec<models::SparseIntEntity>) -> SparseIntMutator {
        SparseIntMutator {
            default_value,
            size,
            sparse_values,
