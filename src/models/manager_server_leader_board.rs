...
pub struct ManagerServerLeaderBoard {
    #[serde(rename = "gameId")]
    pub game_id: String,
    #[serde(rename = "data")]
    pub data: Vec<models::ManagerPlayerLeaderBoard>,
}

impl ManagerServerLeaderBoard {
    pub fn new(game_id: String, data: Vec<models::ManagerPlayerLeaderBoard>) -> ManagerServerLeaderBoard {
