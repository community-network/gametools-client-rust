...
pub struct FrostbiteWeaponInfo {
...
impl FrostbiteWeaponInfo {
    pub fn new(weapon_name: String, r#type: String, image: String, kills: i32, kills_per_minute: i32, headshots: String, accuracy: String, time_equipped: i32, headshot_kills: i32, shots_fired: i32, shots_hit: i32, hit_v_kills: i32) -> FrostbiteWeaponInfo {
        FrostbiteWeaponInfo {
            weapon_name,
            r#type,
            image,
