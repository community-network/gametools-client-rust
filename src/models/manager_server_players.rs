...
pub struct ManagerServerPlayers {
    #[serde(rename = "serverId")]
    pub server_id: String,
    #[serde(rename = "info")]
    pub info: Box<models::ManagerServerInfo>,
    #[serde(rename = "players")]
    pub players: Vec<models::ManagerServerTeam>,
}

impl ManagerServerPlayers {
    pub fn new(server_id: String, info: models::ManagerServerInfo, players: Vec<models::ManagerServerTeam>) -> ManagerServerPlayers {
