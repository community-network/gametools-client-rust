...
pub struct ProgressionMode {
    #[serde(rename = "value")]
    pub value: String,
    #[serde(rename = "progressibles")]
    pub progressibles: Box<models::Mutator>,
}

impl ProgressionMode {
    pub fn new(value: String, progressibles: models::Mutator) -> ProgressionMode {
        ProgressionMode {
            value,
            progressibles: Box::new(progressibles),
        }
    }
}
