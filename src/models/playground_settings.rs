...
pub struct PlaygroundSettings {
    ...
    #[serde(rename = "gameServerMessage")]
    pub game_server_message: Vec<models::ServerMessage>,
    #[serde(rename = "configName")]
    pub config_name: Box<models::StringValue>,
    #[serde(rename = "ConfigDescription")]
    pub config_description: Box<models::StringValue>,
}

impl PlaygroundSettings {
    pub fn new(name: String, description: String, game_server_message: Vec<models::ServerMessage>, config_name: models::StringValue, config_description: models::StringValue) -> PlaygroundSettings {
        PlaygroundSettings {
            name,
            description,
            game_server_message,
            config_name: Box::new(config_name),
            config_description: Box::new(config_description),
        }
    }
}
