...
pub struct ManagerServerRotation {
...
impl ManagerServerRotation {
    pub fn new(mapname: String, image: String, mode: String, index: i32) -> ManagerServerRotation {
        ManagerServerRotation {
            mapname,
            image,
            mode,
            index,
