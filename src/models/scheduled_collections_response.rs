...
pub struct ScheduledCollectionsResponse {
    #[serde(rename = "collectionList")]
    pub collection_list: Vec<models::Collection>,
}

impl ScheduledCollectionsResponse {
    pub fn new(collection_list: Vec<models::Collection>) -> ScheduledCollectionsResponse {
