...
pub struct Bf4DetailedServerInfo {
    #[serde(rename = "region")]
    pub region: String,
...
impl Bf4DetailedServerInfo {
    pub fn new(region: String, current_map: String, current_map_image: String, description: String, player_amount: i32, prefix: String, server_link: String, players: Vec<models::Bf4PlayerList>, no_bots_player_amount: i32, teams: Vec<models::Bf4Team>) -> Bf4DetailedServerInfo {
