...
pub struct OlderTitleSearch {
    #[serde(rename = "servers")]
    pub servers: Vec<models::OlderTitleServerList>,
}

impl OlderTitleSearch {
    pub fn new(servers: Vec<models::OlderTitleServerList>) -> OlderTitleSearch {
        OlderTitleSearch {
            servers,
        }
    }
