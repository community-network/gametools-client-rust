...
pub struct AvailableIntValues {
    #[serde(rename = "range")]
    pub range: Box<models::IntRange>,
    #[serde(rename = "sparseValues")]
    pub sparse_values: Box<models::SparseIntEntity>,
}

impl AvailableIntValues {
    pub fn new(range: models::IntRange, sparse_values: models::SparseIntEntity) -> AvailableIntValues {
        AvailableIntValues {
            range: Box::new(range),
            sparse_values: Box::new(sparse_values),
        }
    }
}
