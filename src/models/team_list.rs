...
pub struct TeamList {
    ...
    pub team_one: Box<models::ServerTeams>,
    #[serde(rename = "teamTwo")]
    pub team_two: Box<models::ServerTeams>,
}

impl TeamList {
    pub fn new(team_one: models::ServerTeams, team_two: models::ServerTeams) -> TeamList {
        TeamList {
            team_one: Box::new(team_one),
            team_two: Box::new(team_two),
        }
    }
}
