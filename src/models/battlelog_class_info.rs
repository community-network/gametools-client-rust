...
pub struct BattlelogClassInfo {
    ...
    #[serde(rename = "serviceStarAmount")]
    pub service_star_amount: i32,
    #[serde(rename = "serviceStarProgress")]
    pub service_star_progress: String,
    #[serde(rename = "serviceStarProgressAmount")]
    pub service_star_progress_amount: i32,
}

impl BattlelogClassInfo {
    pub fn new(class_name: String, image: String, alt_image: String, score: i32, time_played: String, seconds_played: i32, service_star_amount: i32, service_star_progress: String, service_star_progress_amount: i32) -> BattlelogClassInfo {
        BattlelogClassInfo {
            class_name,
            image,
            alt_image,
            ...
            seconds_played,
            service_star_amount,
            service_star_progress,
            service_star_progress_amount,
        }
    }
}
