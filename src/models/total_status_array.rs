...
pub struct TotalStatusArray {
    ...
    pub server_amount: Vec<i32>,
}

impl TotalStatusArray {
    pub fn new(soldier_amount: Vec<i32>, time_stamps: Vec<String>, start_time: String, end_time: String, server_amount: Vec<i32>) -> TotalStatusArray {
        TotalStatusArray {
            soldier_amount,
            time_stamps,
            start_time,
