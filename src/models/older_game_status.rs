...
pub struct OlderGameStatus {
    #[serde(rename = "regions")]
    pub regions: std::collections::HashMap<String, models::OlderGameRegion>,
}

impl OlderGameStatus {
    pub fn new(regions: std::collections::HashMap<String, models::OlderGameRegion>) -> OlderGameStatus {
        OlderGameStatus {
            regions,
        }
    }
