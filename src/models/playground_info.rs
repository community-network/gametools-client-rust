...
pub struct PlaygroundInfo {
    #[serde(rename = "originalPlayground", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub original_playground: Option<Option<Box<models::Playground>>>,
    #[serde(rename = "validatedPlayground", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub validated_playground: Option<Option<Box<models::Playground>>>,
    #[serde(rename = "tag", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub tag: Option<Option<Vec<models::SettingField>>>,
    #[serde(rename = "progressionMode", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub progression_mode: Option<Option<Box<models::ProgressionMode>>>,
...
impl PlaygroundInfo {
    pub fn new() -> PlaygroundInfo {
        PlaygroundInfo {
            original_playground: None,
            validated_playground: None,
            tag: None,
