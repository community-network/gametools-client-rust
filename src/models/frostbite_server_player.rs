...
pub struct FrostbiteServerPlayer {
    #[serde(rename = "rank")]
    pub rank: i32,
...
impl FrostbiteServerPlayer {
    pub fn new(rank: i32, latency: i32, slot: i32, join_time: i32, user_id: i32, player_id: i32, name: String, platoon: String) -> FrostbiteServerPlayer {
