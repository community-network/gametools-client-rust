...
pub struct InCompatibleModRules {
    #[serde(rename = "rules")]
    pub rules: std::path::PathBuf,
    #[serde(rename = "compiledOld")]
    pub compiled_old: std::path::PathBuf,
    #[serde(rename = "rulesVersion")]
    pub rules_version: i32,
}

impl InCompatibleModRules {
    pub fn new(rules: std::path::PathBuf, compiled_old: std::path::PathBuf, rules_version: i32) -> InCompatibleModRules {
        InCompatibleModRules {
            rules,
            compiled_old,
            rules_version,
        }
