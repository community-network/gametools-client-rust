...
impl std::fmt::Display for Bf2PlatformAll {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        match self {
            Self::Bf2hub => write!(f, "bf2hub"),
            Self::Playbf2 => write!(f, "playbf2"),
            Self::All => write!(f, "all"),
        }
    }
}

impl Default for Bf2PlatformAll {
    fn default() -> Bf2PlatformAll {
        Self::Bf2hub
    }
}
