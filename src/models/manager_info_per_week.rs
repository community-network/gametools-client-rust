...
pub struct ManagerInfoPerWeek {
    #[serde(rename = "bfbanKicks")]
    pub bfban_kicks: i32,
    #[serde(rename = "movedPlayers")]
    pub moved_players: i32,
    #[serde(rename = "kickedPlayers")]
    pub kicked_players: i32,
    #[serde(rename = "bannedPlayers")]
    pub banned_players: i32,
    #[serde(rename = "globalbanKicks")]
    pub globalban_kicks: i32,
    #[serde(rename = "pingKicks")]
    pub ping_kicks: i32,
}

impl ManagerInfoPerWeek {
    pub fn new(bfban_kicks: i32, moved_players: i32, kicked_players: i32, banned_players: i32, globalban_kicks: i32, ping_kicks: i32) -> ManagerInfoPerWeek {
        ManagerInfoPerWeek {
            bfban_kicks,
            moved_players,
            kicked_players,
