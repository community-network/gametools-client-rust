...
pub struct BattlelogWeaponStats {
    ...
    pub weapons: Vec<models::BattlelogWeaponInfo>,
}

impl BattlelogWeaponStats {
    pub fn new(id: i32, weapons: Vec<models::BattlelogWeaponInfo>) -> BattlelogWeaponStats {
