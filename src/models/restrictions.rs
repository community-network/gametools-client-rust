...
pub struct Restrictions {
    #[serde(rename = "platformRestrictions")]
    pub platform_restrictions: Box<models::PlatformRestrictions>,
    #[serde(rename = "inputMethodResctrictions")]
    pub input_method_resctrictions: Box<models::InputMethodResrictions>,
}

impl Restrictions {
    pub fn new(platform_restrictions: models::PlatformRestrictions, input_method_resctrictions: models::InputMethodResrictions) -> Restrictions {
        Restrictions {
            platform_restrictions: Box::new(platform_restrictions),
            input_method_resctrictions: Box::new(input_method_resctrictions),
        }
    }
}
