...
pub struct PlaygroundMutator {
    #[serde(rename = "name")]
    pub name: String,
    #[serde(rename = "category")]
    pub category: String,
    #[serde(rename = "kind")]
    pub kind: Box<models::PlaygroundMutatorKind>,
    #[serde(rename = "mutatorId")]
    pub mutator_id: String,
}

impl PlaygroundMutator {
    pub fn new(name: String, category: String, kind: models::PlaygroundMutatorKind, mutator_id: String) -> PlaygroundMutator {
        PlaygroundMutator {
            name,
            category,
            kind: Box::new(kind),
