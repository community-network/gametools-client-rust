...
pub enum V2ManagerLeaderboardSortTypes {
...
impl std::fmt::Display for V2ManagerLeaderboardSortTypes {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        match self {
            Self::TimePlayed => write!(f, "time_played"),
            Self::TotalSessions => write!(f, "total_sessions"),
            Self::Kills => write!(f, "kills"),
            Self::Wins => write!(f, "wins"),
            Self::Deaths => write!(f, "deaths"),
            Self::Losses => write!(f, "losses"),
            Self::Score => write!(f, "score"),
        }
    }
}

impl Default for V2ManagerLeaderboardSortTypes {
    fn default() -> V2ManagerLeaderboardSortTypes {
        Self::TimePlayed
    }
}
