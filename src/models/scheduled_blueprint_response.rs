...
pub struct ScheduledBlueprintResponse {
    #[serde(rename = "blueprint")]
    pub blueprint: Box<models::Blueprint>,
}

impl ScheduledBlueprintResponse {
    pub fn new(blueprint: models::Blueprint) -> ScheduledBlueprintResponse {
