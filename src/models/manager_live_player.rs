...
pub struct ManagerLivePlayer {
    #[serde(rename = "playerInfo")]
    pub player_info: Box<models::ManagerLivePlayerInfo>,
    #[serde(rename = "stats")]
    pub stats: Box<models::ManagerLivePlayerStats>,
    #[serde(rename = "server")]
    pub server: Box<models::ManagerLivePlayerServer>,
    #[serde(rename = "ingamePlayerInfo")]
    pub ingame_player_info: Box<models::ManagerServerPlayer>,
}

impl ManagerLivePlayer {
    pub fn new(player_info: models::ManagerLivePlayerInfo, stats: models::ManagerLivePlayerStats, server: models::ManagerLivePlayerServer, ingame_player_info: models::ManagerServerPlayer) -> ManagerLivePlayer {
        ManagerLivePlayer {
            player_info: Box::new(player_info),
            stats: Box::new(stats),
            server: Box::new(server),
            ingame_player_info: Box::new(ingame_player_info),
        }
    }
}
