...
pub struct FrostbiteGameStatus {
    #[serde(rename = "regions")]
    pub regions: std::collections::HashMap<String, models::Region>,
}

impl FrostbiteGameStatus {
    pub fn new(regions: std::collections::HashMap<String, models::Region>) -> FrostbiteGameStatus {
        FrostbiteGameStatus {
            regions,
        }
    }
