...
pub struct GetProgressionTypesResponse {
    #[serde(rename = "entries")]
    pub entries: Vec<models::ProgressionEntry>,
}

impl GetProgressionTypesResponse {
    pub fn new(entries: Vec<models::ProgressionEntry>) -> GetProgressionTypesResponse {
