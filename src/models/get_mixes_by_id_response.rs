...
pub struct GetMixesByIdResponse {
    #[serde(rename = "mixes")]
    pub mixes: Vec<models::Mix>,
    #[serde(rename = "missingMixes")]
    pub missing_mixes: Vec<models::Mix>,
}

impl GetMixesByIdResponse {
    pub fn new(mixes: Vec<models::Mix>, missing_mixes: Vec<models::Mix>) -> GetMixesByIdResponse {
