...
pub struct Bf2042Setting {
    #[serde(rename = "settingId")]
    pub setting_id: i32,
    #[serde(rename = "name")]
    pub name: String,
    #[serde(rename = "values")]
    pub values: Vec<models::Bf2042SettingsValue>,
}

impl Bf2042Setting {
    pub fn new(setting_id: i32, name: String, values: Vec<models::Bf2042SettingsValue>) -> Bf2042Setting {
        Bf2042Setting {
            setting_id,
            name,
            values,
