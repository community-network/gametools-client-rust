...
pub struct ManagerPlayerLeaderBoardV2 {
...
impl ManagerPlayerLeaderBoardV2 {
    pub fn new(time_played: i32, kills: i32, deaths: i32, wins: i32, losses: i32, gamemodes: Vec<models::ManagerPlayerGamemode>, kits: Vec<models::ManagerPlayerKit>, player_id: i32, name: String, total_sessions: i32, kill_death: i32, score: i32, platoon: String) -> ManagerPlayerLeaderBoardV2 {
        ManagerPlayerLeaderBoardV2 {
            time_played,
            kills,
            deaths,
            wins,
