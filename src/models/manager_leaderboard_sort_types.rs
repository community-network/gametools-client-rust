...
pub enum ManagerLeaderboardSortTypes {
...
impl std::fmt::Display for ManagerLeaderboardSortTypes {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        match self {
            ...
            Self::Killdeath => write!(f, "killdeath"),
            Self::Score => write!(f, "score"),
        }
    }
}

impl Default for ManagerLeaderboardSortTypes {
    fn default() -> ManagerLeaderboardSortTypes {
        Self::Timeplayed
    }
}
