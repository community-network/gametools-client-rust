...
pub struct AvailableTagsResponse {
    #[serde(rename = "availableTags")]
    pub available_tags: Vec<models::AvailableTag>,
}

impl AvailableTagsResponse {
    pub fn new(available_tags: Vec<models::AvailableTag>) -> AvailableTagsResponse {
