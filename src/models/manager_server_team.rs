...
pub struct ManagerServerTeam {
    #[serde(rename = "teamid")]
    pub teamid: i32,
    #[serde(rename = "players")]
    pub players: Vec<models::ManagerServerPlayer>,
    #[serde(rename = "faction")]
    pub faction: String,
}

impl ManagerServerTeam {
    pub fn new(teamid: i32, players: Vec<models::ManagerServerPlayer>, faction: String) -> ManagerServerTeam {
        ManagerServerTeam {
            teamid,
            players,
            faction,
