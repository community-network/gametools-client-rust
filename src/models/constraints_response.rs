...
pub struct ConstraintsResponse {
    ...
    pub global_constraints: Box<models::GlobalConstraints>,
}

impl ConstraintsResponse {
    pub fn new(global_constraints: models::GlobalConstraints) -> ConstraintsResponse {
        ConstraintsResponse {
            global_constraints: Box::new(global_constraints),
        }
    }
}
