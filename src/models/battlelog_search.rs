...
pub struct BattlelogSearch {
    #[serde(rename = "servers")]
    pub servers: Vec<models::BattlelogServerList>,
}

impl BattlelogSearch {
    pub fn new(servers: Vec<models::BattlelogServerList>) -> BattlelogSearch {
        BattlelogSearch {
            servers,
        }
    }
