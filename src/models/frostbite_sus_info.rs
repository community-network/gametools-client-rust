...
pub struct FrostbiteSusInfo {
    ...
    pub hit_v_kills: i32,
    #[serde(rename = "susReason")]
    pub sus_reason: String,
}

impl FrostbiteSusInfo {
    pub fn new(weapon_name: String, r#type: String, image: String, kills: i32, kills_per_minute: i32, headshots: String, accuracy: String, time_equipped: i32, headshot_kills: i32, shots_fired: i32, shots_hit: i32, hit_v_kills: i32, sus_reason: String) -> FrostbiteSusInfo {
        FrostbiteSusInfo {
            weapon_name,
            r#type,
            image,
