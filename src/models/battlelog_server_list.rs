...
pub struct BattlelogServerList {
    #[serde(rename = "url")]
    pub url: String,
    #[serde(rename = "server")]
    pub server: String,
...
impl BattlelogServerList {
    pub fn new(url: String, server: String, map: String, max_players: i32, in_queue: i32, server_list: String, game_id: String) -> BattlelogServerList {
        BattlelogServerList {
            url,
            server,
            map,
