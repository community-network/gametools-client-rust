...
pub struct MenuEntry {
    ...
    pub resource: Vec<models::SlotResourceLocation>,
    #[serde(rename = "translations")]
    pub translations: Vec<models::MutatorItem>,
}

impl MenuEntry {
    pub fn new(resource: Vec<models::SlotResourceLocation>, translations: Vec<models::MutatorItem>) -> MenuEntry {
        MenuEntry {
            resource,
            translations,
        }
