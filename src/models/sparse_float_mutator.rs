...
pub struct SparseFloatMutator {
    #[serde(rename = "defaultValue")]
    pub default_value: f64,
    #[serde(rename = "size")]
    pub size: i32,
    #[serde(rename = "sparseValues")]
    pub sparse_values: Vec<models::SparseFloatEntity>,
}

impl SparseFloatMutator {
    pub fn new(default_value: f64, size: i32, sparse_values: Vec<models::SparseFloatEntity>) -> SparseFloatMutator {
        SparseFloatMutator {
            default_value,
            size,
            sparse_values,
