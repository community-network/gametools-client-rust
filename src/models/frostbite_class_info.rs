...
impl FrostbiteClassInfo {
    pub fn new(class_name: String, image: String, alt_image: String, score: i32, time_played: String, seconds_played: i32, kills: i32, kpm: i32) -> FrostbiteClassInfo {
        FrostbiteClassInfo {
            class_name,
            image,
            alt_image,
