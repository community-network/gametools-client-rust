...
pub struct AvailableIntValue {
    #[serde(rename = "defaultValue")]
    pub default_value: i32,
    #[serde(rename = "availableValues")]
    pub available_values: Box<models::AvailableIntValues>,
}

impl AvailableIntValue {
    pub fn new(default_value: i32, available_values: models::AvailableIntValues) -> AvailableIntValue {
        AvailableIntValue {
            default_value,
            available_values: Box::new(available_values),
        }
    }
}
