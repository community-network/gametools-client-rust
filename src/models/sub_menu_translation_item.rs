...
pub struct SubMenuTranslationItem {
    #[serde(rename = "item")]
    pub item: Box<models::MutatorTranslations>,
}

impl SubMenuTranslationItem {
    pub fn new(item: models::MutatorTranslations) -> SubMenuTranslationItem {
        SubMenuTranslationItem {
            item: Box::new(item),
        }
    }
}
