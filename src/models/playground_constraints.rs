...
pub struct PlaygroundConstraints {
    #[serde(rename = "maxNameSize")]
    pub max_name_size: i32,
    #[serde(rename = "maxDescriptionSize")]
    pub max_description_size: i32,
    #[serde(rename = "maxSecretSize")]
    pub max_secret_size: i32,
    #[serde(rename = "maxMapsInRotation")]
    pub max_maps_in_rotation: i32,
    #[serde(rename = "maxMutators")]
    pub max_mutators: i32,
    #[serde(rename = "maxConfigNameSize")]
    pub max_config_name_size: i32,
    #[serde(rename = "maxConfigDescriptionSize")]
    pub max_config_description_size: i32,
}

impl PlaygroundConstraints {
    pub fn new(max_name_size: i32, max_description_size: i32, max_secret_size: i32, max_maps_in_rotation: i32, max_mutators: i32, max_config_name_size: i32, max_config_description_size: i32) -> PlaygroundConstraints {
        PlaygroundConstraints {
            max_name_size,
            max_description_size,
            max_secret_size,
            max_maps_in_rotation,
            max_mutators,
            max_config_name_size,
            max_config_description_size,
        }
    }
}
