...
pub struct ServerSettings {
    #[serde(rename = "Kits")]
    pub kits: std::collections::HashMap<String, String>,
    #[serde(rename = "Misc")]
    pub misc: std::collections::HashMap<String, String>,
    #[serde(rename = "Scales")]
    pub scales: std::collections::HashMap<String, String>,
    #[serde(rename = "Vehicles")]
    pub vehicles: std::collections::HashMap<String, String>,
    #[serde(rename = "Weapons")]
    pub weapons: std::collections::HashMap<String, String>,
}

impl ServerSettings {
    pub fn new(kits: std::collections::HashMap<String, String>, misc: std::collections::HashMap<String, String>, scales: std::collections::HashMap<String, String>, vehicles: std::collections::HashMap<String, String>, weapons: std::collections::HashMap<String, String>) -> ServerSettings {
        ServerSettings {
            kits,
            misc,
            scales,
