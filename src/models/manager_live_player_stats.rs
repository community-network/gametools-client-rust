...
pub struct ManagerLivePlayerStats {
...
impl ManagerLivePlayerStats {
    pub fn new(time_played: i32, kills: i32, deaths: i32, wins: i32, losses: i32, gamemodes: Vec<models::ManagerPlayerGamemode>, kits: Vec<models::ManagerPlayerKit>) -> ManagerLivePlayerStats {
        ManagerLivePlayerStats {
            time_played,
            kills,
            deaths,
            wins,
