...
pub struct StoreLayout {
    ...
    pub featured: Vec<models::StoreRow>,
    #[serde(rename = "upcomingFeatured")]
    pub upcoming_featured: Vec<models::StoreCategory>,
    #[serde(rename = "battlepassBanner")]
    pub battlepass_banner: Box<models::BattlepassBanner>,
}

impl StoreLayout {
    pub fn new(featured: Vec<models::StoreRow>, upcoming_featured: Vec<models::StoreCategory>, battlepass_banner: models::BattlepassBanner) -> StoreLayout {
        StoreLayout {
            featured,
            upcoming_featured,
            battlepass_banner: Box::new(battlepass_banner),
        }
    }
}
