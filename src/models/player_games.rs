...
pub struct PlayerGames {
    ...
    #[serde(rename = "bf2042")]
    pub bf2042: bool,
    #[serde(rename = "emblem", deserialize_with = "Option::deserialize")]
    pub emblem: Option<String>,
}

impl PlayerGames {
    pub fn new(id: i32, bf1: bool, bf4: bool, bfv: bool, bf3: bool, bfh: bool, bf2042: bool, emblem: Option<String>) -> PlayerGames {
        PlayerGames {
            avatar: None,
            id,
            user_name: None,
