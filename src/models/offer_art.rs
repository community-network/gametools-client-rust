...
pub struct OfferArt {
    #[serde(rename = "defaultArt")]
    pub default_art: Box<models::StoreBanner>,
    #[serde(rename = "portrait")]
    pub portrait: Box<models::StoreBanner>,
    #[serde(rename = "doublePortrait")]
    pub double_portrait: Box<models::StoreBanner>,
    #[serde(rename = "wide")]
    pub wide: Box<models::StoreBanner>,
    #[serde(rename = "custom")]
    pub custom: Box<models::StoreBanner>,
    #[serde(rename = "full")]
    pub full: Box<models::StoreBanner>,
}

impl OfferArt {
    pub fn new(default_art: models::StoreBanner, portrait: models::StoreBanner, double_portrait: models::StoreBanner, wide: models::StoreBanner, custom: models::StoreBanner, full: models::StoreBanner) -> OfferArt {
        OfferArt {
            default_art: Box::new(default_art),
            portrait: Box::new(portrait),
            double_portrait: Box::new(double_portrait),
            wide: Box::new(wide),
