...
pub struct Amount {
    ...
    pub soldier_amount: i32,
    #[serde(rename = "spectatorAmount")]
    pub spectator_amount: i32,
    #[serde(rename = "queueAmount")]
    pub queue_amount: i32,
    #[serde(rename = "serverAmount")]
    pub server_amount: i32,
}

impl Amount {
    pub fn new(soldier_amount: i32, spectator_amount: i32, queue_amount: i32, server_amount: i32) -> Amount {
        Amount {
            soldier_amount,
            spectator_amount,
            queue_amount,
