...
pub enum BfVietnamPlatform {
    #[serde(rename = "qtracker")]
    Qtracker,
    #[serde(rename = "openspy")]
    Openspy,

}

impl std::fmt::Display for BfVietnamPlatform {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        match self {
            Self::Qtracker => write!(f, "qtracker"),
            Self::Openspy => write!(f, "openspy"),
        }
    }
}

impl Default for BfVietnamPlatform {
    fn default() -> BfVietnamPlatform {
        Self::Qtracker
    }
}
