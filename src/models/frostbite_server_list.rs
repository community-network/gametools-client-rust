...
pub struct FrostbiteServerList {
    #[serde(rename = "prefix")]
    pub prefix: String,
    #[serde(rename = "url")]
    pub url: String,
...
impl FrostbiteServerList {
    pub fn new(prefix: String, url: String, current_map: String, in_que: i32, mode: String, owner_id: i32, player_amount: i32, region: String, small_mode: String, max_players: i32, game_id: String, official: bool, platform: String, teams: models::TeamList, server_info: String) -> FrostbiteServerList {
        FrostbiteServerList {
            prefix,
            url,
            current_map,
