...
pub struct FrostbiteServerTeam {
    #[serde(rename = "teamid")]
    pub teamid: String,
    #[serde(rename = "image")]
    pub image: String,
    ...
    pub players: Vec<models::FrostbiteServerPlayer>,
    #[serde(rename = "key")]
    pub key: String,
...
impl FrostbiteServerTeam {
    pub fn new(teamid: String, image: String, name: String, players: Vec<models::FrostbiteServerPlayer>, key: String, faction: String) -> FrostbiteServerTeam {
        FrostbiteServerTeam {
            teamid,
            image,
            name,
