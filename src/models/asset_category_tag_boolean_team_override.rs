...
pub struct AssetCategoryTagBooleanTeamOverride {
    #[serde(rename = "assetCategoryTags")]
    pub asset_category_tags: Vec<String>,
    #[serde(rename = "value")]
    pub value: bool,
    #[serde(rename = "teamId")]
    pub team_id: i32,
...
impl AssetCategoryTagBooleanTeamOverride {
    pub fn new(asset_category_tags: Vec<String>, value: bool, team_id: i32) -> AssetCategoryTagBooleanTeamOverride {
        AssetCategoryTagBooleanTeamOverride {
            asset_category_tags,
            value,
            team_id,
        }
