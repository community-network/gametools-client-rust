...
impl BfvServerTeam {
    pub fn new(teamid: String, image: String, name: String, players: Vec<models::FrostbiteServerPlayer>, key: String, faction: String, short_name: String) -> BfvServerTeam {
        BfvServerTeam {
            teamid,
            image,
            name,
