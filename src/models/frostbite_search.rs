...
pub struct FrostbiteSearch {
    #[serde(rename = "servers")]
    pub servers: Vec<models::FrostbiteServerList>,
}

impl FrostbiteSearch {
    pub fn new(servers: Vec<models::FrostbiteServerList>) -> FrostbiteSearch {
        FrostbiteSearch {
            servers,
        }
    }
