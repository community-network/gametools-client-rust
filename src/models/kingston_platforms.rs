...
impl std::fmt::Display for KingstonPlatforms {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        match self {
            Self::Pc => write!(f, "pc"),
            Self::Xboxone => write!(f, "xboxone"),
            Self::Ps4 => write!(f, "ps4"),
            Self::Xboxseries => write!(f, "xboxseries"),
...
impl Default for KingstonPlatforms {
    fn default() -> KingstonPlatforms {
        Self::Pc
    }
}
