...
pub struct Offer {
    #[serde(rename = "xbox")]
    pub xbox: Box<models::OfferIdXbox>,
    #[serde(rename = "ps")]
    pub ps: Box<models::OfferIdPlayStation>,
    #[serde(rename = "pc")]
    pub pc: Box<models::OfferIdOrigin>,
    #[serde(rename = "crossPlatformId")]
    pub cross_platform_id: String,
}

impl Offer {
    pub fn new(xbox: models::OfferIdXbox, ps: models::OfferIdPlayStation, pc: models::OfferIdOrigin, cross_platform_id: String) -> Offer {
        Offer {
            xbox: Box::new(xbox),
            ps: Box::new(ps),
            pc: Box::new(pc),
