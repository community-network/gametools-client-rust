...
pub struct AvailableAssetCategories {
    #[serde(rename = "rootTags")]
    pub root_tags: Vec<models::AvailableAssetCategoryTag>,
    #[serde(rename = "tags")]
    pub tags: Vec<models::AvailableAssetCategoryTag>,
}

impl AvailableAssetCategories {
    pub fn new(root_tags: Vec<models::AvailableAssetCategoryTag>, tags: Vec<models::AvailableAssetCategoryTag>) -> AvailableAssetCategories {
