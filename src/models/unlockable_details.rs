...
pub struct UnlockableDetails {
    #[serde(rename = "identifier")]
    pub identifier: Vec<models::BundleItems>,
    #[serde(rename = "rankinfo")]
    pub rankinfo: Box<models::RankInfo>,
}

impl UnlockableDetails {
    pub fn new(identifier: Vec<models::BundleItems>, rankinfo: models::RankInfo) -> UnlockableDetails {
        UnlockableDetails {
            identifier,
            rankinfo: Box::new(rankinfo),
        }
    }
}
