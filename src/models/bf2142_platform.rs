...
pub enum Bf2142Platform {
    #[serde(rename = "openspy")]
    Openspy,
    #[serde(rename = "play2142")]
    Play2142,

}

impl std::fmt::Display for Bf2142Platform {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        match self {
            Self::Openspy => write!(f, "openspy"),
            Self::Play2142 => write!(f, "play2142"),
        }
    }
}

impl Default for Bf2142Platform {
    fn default() -> Bf2142Platform {
        Self::Openspy
    }
}
