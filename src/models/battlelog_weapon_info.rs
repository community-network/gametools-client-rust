...
pub struct BattlelogWeaponInfo {
...
impl BattlelogWeaponInfo {
    pub fn new(weapon_name: String, r#type: String, image: String, kills: i32, kills_per_minute: i32, headshots: String, accuracy: String, alt_image: String) -> BattlelogWeaponInfo {
        BattlelogWeaponInfo {
            weapon_name,
            r#type,
            image,
