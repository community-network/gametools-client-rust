...
pub struct DetailedPlatoonInfo {
    #[serde(rename = "id")]
    pub id: String,
    #[serde(rename = "name")]
    pub name: String,
    ...
    #[serde(rename = "canApplyToJoin")]
    pub can_apply_to_join: bool,
    #[serde(rename = "canJoinWithoutApply")]
    pub can_join_without_apply: bool,
    #[serde(rename = "members")]
    pub members: Vec<models::PlatoonMember>,
    #[serde(rename = "servers")]
    pub servers: Vec<models::PlatoonServer>,
}

impl DetailedPlatoonInfo {
    pub fn new(id: String, name: String, tag: String, current_size: i32, emblem: String, description: String, can_apply_to_join: bool, can_join_without_apply: bool, members: Vec<models::PlatoonMember>, servers: Vec<models::PlatoonServer>) -> DetailedPlatoonInfo {
        DetailedPlatoonInfo {
            id,
            name,
            tag,
