...
pub struct SessionStats {
    ...
    pub deaths: i32,
    #[serde(rename = "kits")]
    pub kits: Vec<models::SessionKitStats>,
    #[serde(rename = "score")]
    pub score: i32,
    #[serde(rename = "gamemodes")]
    pub gamemodes: Vec<models::SessionGamemodeStats>,
}

impl SessionStats {
    pub fn new(time_played: i32, wins: i32, losses: i32, kills: i32, deaths: i32, kits: Vec<models::SessionKitStats>, score: i32, gamemodes: Vec<models::SessionGamemodeStats>) -> SessionStats {
        SessionStats {
            time_played,
            wins,
            losses,
