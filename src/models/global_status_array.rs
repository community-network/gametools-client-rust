...
pub struct GlobalStatusArray {
    ...
    #[serde(rename = "bfh")]
    pub bfh: Vec<i32>,
    #[serde(rename = "bfvietnam")]
    pub bfvietnam: Vec<i32>,
    #[serde(rename = "bf1")]
    pub bf1: Vec<i32>,
...
impl GlobalStatusArray {
    pub fn new(bf3: Vec<i32>, bfbc2: Vec<i32>, bf2142: Vec<i32>, playbf2: Vec<i32>, bf2hub: Vec<i32>, bf4: Vec<i32>, bfv: Vec<i32>, bfh: Vec<i32>, bfvietnam: Vec<i32>, bf1: Vec<i32>, time_stamps: Vec<String>, start_time: String, end_time: String) -> GlobalStatusArray {
        GlobalStatusArray {
            bf3,
            bfbc2,
            bf2142,
