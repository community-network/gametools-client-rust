...
pub struct ManagerLivePlayerServer {
    #[serde(rename = "name")]
    pub name: String,
    #[serde(rename = "mode")]
    pub mode: String,
    ...
    #[serde(rename = "url")]
    pub url: String,
    #[serde(rename = "isInServer")]
    pub is_in_server: bool,
}

impl ManagerLivePlayerServer {
    pub fn new(name: String, mode: String, map: String, player_amount: i32, max_player_amount: i32, url: String, is_in_server: bool) -> ManagerLivePlayerServer {
        ManagerLivePlayerServer {
            name,
            mode,
            map,
            player_amount,
