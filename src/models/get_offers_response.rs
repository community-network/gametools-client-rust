...
pub struct GetOffersResponse {
    ...
    pub bundles: Vec<models::StoreLayout>,
    #[serde(rename = "items")]
    pub items: Vec<models::StoreOffer>,
    #[serde(rename = "unlocks")]
    pub unlocks: Vec<models::UnlockableStoreItem>,
    #[serde(rename = "validUntil")]
    pub valid_until: Box<models::DateInterval>,
}

impl GetOffersResponse {
    pub fn new(identifier: String, bundles: Vec<models::StoreLayout>, items: Vec<models::StoreOffer>, unlocks: Vec<models::UnlockableStoreItem>, valid_until: models::DateInterval) -> GetOffersResponse {
        GetOffersResponse {
            identifier,
            bundles,
            items,
            unlocks,
            valid_until: Box::new(valid_until),
        }
    }
}
