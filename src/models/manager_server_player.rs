...
pub struct ManagerServerPlayer {
...
impl ManagerServerPlayer {
    pub fn new(player_id: i32, user_id: i32, name: String, position: i32, rank: i32, ping: i32, platoon: String, join_time: i32, localization: String) -> ManagerServerPlayer {
        ManagerServerPlayer {
            player_id,
            user_id,
            name,
