...
pub struct AvailableGameData {
    #[serde(rename = "mutators")]
    pub mutators: Vec<models::AvailableMutator>,
    #[serde(rename = "maps")]
    pub maps: Vec<models::AvailableMapEntry>,
    #[serde(rename = "modRules")]
    pub mod_rules: Box<models::ModRulesDefinition>,
    #[serde(rename = "assetCategories")]
    pub asset_categories: Box<models::AvailableAssetCategories>,
}

impl AvailableGameData {
    pub fn new(mutators: Vec<models::AvailableMutator>, maps: Vec<models::AvailableMapEntry>, mod_rules: models::ModRulesDefinition, asset_categories: models::AvailableAssetCategories) -> AvailableGameData {
        AvailableGameData {
            mutators,
            maps,
            mod_rules: Box::new(mod_rules),
            asset_categories: Box::new(asset_categories),
        }
    }
}
