...
pub struct GetStoreCatalogResponse {
    #[serde(rename = "storeOffers")]
    pub store_offers: Vec<models::Offer>,
}

impl GetStoreCatalogResponse {
    pub fn new(store_offers: Vec<models::Offer>) -> GetStoreCatalogResponse {
