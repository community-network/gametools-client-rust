...
pub struct Bf2042SettingsValue {
    #[serde(rename = "settingName")]
    pub setting_name: String,
    #[serde(rename = "assignValue")]
    pub assign_value: String,
    #[serde(rename = "readableSettingName")]
    pub readable_setting_name: String,
}

impl Bf2042SettingsValue {
    pub fn new(setting_name: String, assign_value: String, readable_setting_name: String) -> Bf2042SettingsValue {
        Bf2042SettingsValue {
            setting_name,
            assign_value,
            readable_setting_name,
        }
    }
}
