...
pub struct StatsArray {
    ...
    pub headshots: Vec<i32>,
    #[serde(rename = "infantryKillDeath")]
    pub infantry_kill_death: Vec<i32>,
    #[serde(rename = "infantryKillsPerMinute")]
    pub infantry_kills_per_minute: Vec<i32>,
    #[serde(rename = "killDeath")]
    pub kill_death: Vec<i32>,
    #[serde(rename = "killsPerMinute")]
    pub kills_per_minute: Vec<i32>,
    #[serde(rename = "scorePerMinute")]
    pub score_per_minute: Vec<i32>,
    #[serde(rename = "skill")]
    pub skill: Vec<i32>,
    #[serde(rename = "winPercent")]
    pub win_percent: Vec<i32>,
...
impl StatsArray {
    pub fn new(accuracy: Vec<i32>, headshots: Vec<i32>, infantry_kill_death: Vec<i32>, infantry_kills_per_minute: Vec<i32>, kill_death: Vec<i32>, kills_per_minute: Vec<i32>, score_per_minute: Vec<i32>, skill: Vec<i32>, win_percent: Vec<i32>, time_stamps: Vec<String>, start_time: String, end_time: String) -> StatsArray {
        StatsArray {
            accuracy,
            headshots,
            infantry_kill_death,
