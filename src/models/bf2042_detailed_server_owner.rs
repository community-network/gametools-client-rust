...
pub struct Bf2042DetailedServerOwner {
    #[serde(rename = "nucleusId")]
    pub nucleus_id: i32,
...
impl Bf2042DetailedServerOwner {
    pub fn new(nucleus_id: i32, persona_id: i32, platform_id: i32, platform: String, id: i32, name: String, avatar: String) -> Bf2042DetailedServerOwner {
