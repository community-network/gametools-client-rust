...
pub struct Bf1ServerPlayers {
    #[serde(rename = "serverinfo")]
    pub serverinfo: Box<models::ServerInfo>,
    #[serde(rename = "teams")]
    pub teams: Vec<models::FrostbiteServerTeam>,
    #[serde(rename = "que")]
    pub que: Vec<models::FrostbiteServerPlayer>,
    #[serde(rename = "loading")]
    pub loading: Vec<models::FrostbiteServerPlayer>,
    #[serde(rename = "update_timestamp")]
    pub update_timestamp: i32,
}

impl Bf1ServerPlayers {
    pub fn new(serverinfo: models::ServerInfo, teams: Vec<models::FrostbiteServerTeam>, que: Vec<models::FrostbiteServerPlayer>, loading: Vec<models::FrostbiteServerPlayer>, update_timestamp: i32) -> Bf1ServerPlayers {
        Bf1ServerPlayers {
            serverinfo: Box::new(serverinfo),
            teams,
            que,
            loading,
            update_timestamp,
