...
pub struct FrostbiteSusStats {
    ...
    pub vehicles: Vec<models::FrostbiteSusInfo>,
}

impl FrostbiteSusStats {
    pub fn new(id: i32, vehicles: Vec<models::FrostbiteSusInfo>) -> FrostbiteSusStats {
        FrostbiteSusStats {
            avatar: None,
            id,
            user_name: None,
