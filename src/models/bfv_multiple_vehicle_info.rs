...
pub struct BfvMultipleVehicleInfo {
    #[serde(rename = "type")]
    pub r#type: String,
    ...
    #[serde(rename = "vehiclesDestroyedWith")]
    pub vehicles_destroyed_with: i32,
}

impl BfvMultipleVehicleInfo {
    pub fn new(r#type: String, vehicle_name: String, image: String, id: String, kills: i32, kills_per_minute: i32, vehicles_destroyed_with: i32) -> BfvMultipleVehicleInfo {
        BfvMultipleVehicleInfo {
            r#type,
            vehicle_name,
            image,
            id,
