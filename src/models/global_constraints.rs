...
pub struct GlobalConstraints {
    #[serde(rename = "maxPlaygroundsPerPlayer")]
    pub max_playgrounds_per_player: i32,
    #[serde(rename = "maxGameServersPerPlayer")]
    pub max_game_servers_per_player: i32,
    #[serde(rename = "maxFollowedHostsListSize")]
    pub max_followed_hosts_list_size: i32,
}

impl GlobalConstraints {
    pub fn new(max_playgrounds_per_player: i32, max_game_servers_per_player: i32, max_followed_hosts_list_size: i32) -> GlobalConstraints {
        GlobalConstraints {
            max_playgrounds_per_player,
            max_game_servers_per_player,
            max_followed_hosts_list_size,
        }
    }
}
