...
pub struct ManagerPlayerGamemode {
    #[serde(rename = "name")]
    pub name: String,
    #[serde(rename = "score")]
    pub score: i32,
...
impl ManagerPlayerGamemode {
    pub fn new(name: String, score: i32, wins: i32, losses: i32) -> ManagerPlayerGamemode {
        ManagerPlayerGamemode {
            name,
            score,
            wins,
            losses,
