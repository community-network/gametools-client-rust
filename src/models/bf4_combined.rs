...
pub struct Bf4Combined {
    ...
    #[serde(rename = "quits")]
    pub quits: String,
    #[serde(rename = "resupplies")]
    pub resupplies: i32,
    #[serde(rename = "weapons")]
    pub weapons: Vec<models::BattlelogWeaponStats>,
    #[serde(rename = "vehicles")]
    pub vehicles: Vec<models::BattlelogVehicleStats>,
    #[serde(rename = "platoon")]
    pub platoon: Box<models::BattlelogPlatoonInfo>,
    #[serde(rename = "classes")]
    pub classes: Vec<models::BattlelogClassInfo>,
    #[serde(rename = "gamemodes")]
    pub gamemodes: Vec<models::GamemodeInfo>,
    #[serde(rename = "progress")]
    pub progress: Vec<models::ProgressInfo>,
}

impl Bf4Combined {
    pub fn new(id: i32, rank: i32, rank_img: String, kills_per_minute: i32, score_per_minute: i32, win_percent: i32, best_class: i32, accuracy: i32, time_played: String, seconds_played: i32, kill_death: i32, kills: i32, deaths: i32, wins: i32, loses: i32, heals: i32, repairs: i32, avenger_kills: i32, savior_kills: i32, head_shots: i32, kill_assists: i32, skill: i32, revives: i32, longest_head_shot: i32, highest_kill_streak: i32, current_rank_progress: i32, total_rank_progress: i32, rank_name: String, quits: String, resupplies: i32, weapons: Vec<models::BattlelogWeaponStats>, vehicles: Vec<models::BattlelogVehicleStats>, platoon: models::BattlelogPlatoonInfo, classes: Vec<models::BattlelogClassInfo>, gamemodes: Vec<models::GamemodeInfo>, progress: Vec<models::ProgressInfo>) -> Bf4Combined {
        Bf4Combined {
            avatar: None,
            id,
            user_name: None,
