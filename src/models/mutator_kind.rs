...
pub struct MutatorKind {
    ...
    pub float_value: Option<Option<Box<models::FloatMutator>>>,
    ...
    pub float_sparse: Option<Option<Box<models::SparseFloatMutator>>>,
}

impl MutatorKind {
    pub fn new() -> MutatorKind {
        MutatorKind {
            bool_value: None,
            string_value: None,
            float_value: None,
