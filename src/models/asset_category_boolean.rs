...
pub struct AssetCategoryBoolean {
    #[serde(rename = "defaultValue")]
    pub default_value: bool,
    #[serde(rename = "overrides")]
    pub overrides: Box<models::AssetCategoryTagBooleanOverride>,
    #[serde(rename = "teamOverrides")]
    pub team_overrides: Box<models::AssetCategoryTagBooleanTeamOverride>,
}

impl AssetCategoryBoolean {
    pub fn new(default_value: bool, overrides: models::AssetCategoryTagBooleanOverride, team_overrides: models::AssetCategoryTagBooleanTeamOverride) -> AssetCategoryBoolean {
        AssetCategoryBoolean {
            default_value,
            overrides: Box::new(overrides),
            team_overrides: Box::new(team_overrides),
        }
    }
}
