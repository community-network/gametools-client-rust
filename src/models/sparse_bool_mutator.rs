...
pub struct SparseBoolMutator {
    #[serde(rename = "defaultValue")]
    pub default_value: bool,
    #[serde(rename = "siz")]
    pub siz: i32,
    #[serde(rename = "sparseValues")]
    pub sparse_values: Vec<models::SparseBoolMutatorEntry>,
}

impl SparseBoolMutator {
    pub fn new(default_value: bool, siz: i32, sparse_values: Vec<models::SparseBoolMutatorEntry>) -> SparseBoolMutator {
        SparseBoolMutator {
            default_value,
            siz,
            sparse_values,
