...
pub struct PlaygroundSparseFloatMutator {
    #[serde(rename = "defaultValue")]
    pub default_value: i32,
    #[serde(rename = "size")]
    pub size: i32,
    #[serde(rename = "sparseValues")]
    pub sparse_values: Vec<models::PlaygroundSparseFloatEntity>,
}

impl PlaygroundSparseFloatMutator {
    pub fn new(default_value: i32, size: i32, sparse_values: Vec<models::PlaygroundSparseFloatEntity>) -> PlaygroundSparseFloatMutator {
        PlaygroundSparseFloatMutator {
            default_value,
            size,
            sparse_values,
        }
