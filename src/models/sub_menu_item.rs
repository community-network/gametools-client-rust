...
pub struct SubMenuItem {
    ...
    pub gamemode: String,
    #[serde(rename = "assets")]
    pub assets: Box<models::SubMenuTranslationItem>,
    #[serde(rename = "mixInfo")]
    pub mix_info: Box<models::CollectionSlot>,
}

impl SubMenuItem {
    pub fn new(gamemode: String, assets: models::SubMenuTranslationItem, mix_info: models::CollectionSlot) -> SubMenuItem {
        SubMenuItem {
            gamemode,
            assets: Box::new(assets),
            mix_info: Box::new(mix_info),
        }
    }
}
