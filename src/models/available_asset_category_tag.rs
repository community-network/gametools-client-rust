...
pub struct AvailableAssetCategoryTag {
    #[serde(rename = "tagId")]
    pub tag_id: String,
    #[serde(rename = "name")]
    pub name: String,
...
impl AvailableAssetCategoryTag {
    pub fn new(tag_id: String, name: String, children_tags: Vec<String>, metadata: models::Metadata) -> AvailableAssetCategoryTag {
        AvailableAssetCategoryTag {
            tag_id,
            name,
            children_tags,
