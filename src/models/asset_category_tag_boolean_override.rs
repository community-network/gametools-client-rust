...
pub struct AssetCategoryTagBooleanOverride {
...
impl AssetCategoryTagBooleanOverride {
    pub fn new(asset_category_tags: Vec<String>, value: bool) -> AssetCategoryTagBooleanOverride {
