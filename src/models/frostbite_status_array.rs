...
pub struct FrostbiteStatusArray {
    #[serde(rename = "soldierAmount")]
    pub soldier_amount: Vec<i32>,
    ...
    pub community_soldier_amount: Vec<i32>,
    #[serde(rename = "diceSoldierAmount")]
    pub dice_soldier_amount: Vec<i32>,
}

impl FrostbiteStatusArray {
    pub fn new(soldier_amount: Vec<i32>, time_stamps: Vec<String>, start_time: String, end_time: String, community_soldier_amount: Vec<i32>, dice_soldier_amount: Vec<i32>) -> FrostbiteStatusArray {
        FrostbiteStatusArray {
            soldier_amount,
            time_stamps,
            start_time,
            end_time,
            community_soldier_amount,
            dice_soldier_amount,
        }
    }
}
